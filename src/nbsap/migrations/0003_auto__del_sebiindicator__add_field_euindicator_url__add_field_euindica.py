...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SEBIIndicator'
        db.delete_table(u'nbsap_sebiindicator')

        # Adding field 'EuIndicator.url'
        db.add_column(u'nbsap_euindicator', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EuIndicator.indicator_type'
        db.add_column(u'nbsap_euindicator', 'indicator_type',
        ...
        db.add_column(u'nbsap_euindicator', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['nbsap.EuIndicator']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'SEBIIndicator'
        db.create_table(u'nbsap_sebiindicator', (
        ...
        db.send_create_signal(u'nbsap', ['SEBIIndicator'])

        # Deleting field 'EuIndicator.url'
        db.delete_column(u'nbsap_euindicator', 'url')

        # Deleting field 'EuIndicator.indicator_type'
        db.delete_column(u'nbsap_euindicator', 'indicator_type')
    ...
    models = {
        ...
        u'nbsap.euindicator': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator_type': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['nbsap.EuIndicator']"}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'title_fr': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'title_nl': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EuIndicator.indicator_type'
        db.alter_column(u'nbsap_euindicator', 'indicator_type', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'EuIndicator.indicator_type'
        db.alter_column(u'nbsap_euindicator', 'indicator_type', self.gf('django.db.models.fields.CharField')(max_length=3))

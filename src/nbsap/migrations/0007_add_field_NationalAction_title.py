...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NationalAction.title_en'
        db.add_column(u'nbsap_nationalaction', 'title_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'NationalAction.title_fr'
        db.add_column(u'nbsap_nationalaction', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NationalAction.title_nl'
        db.add_column(u'nbsap_nationalaction', 'title_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NationalAction.title_en'
        db.delete_column(u'nbsap_nationalaction', 'title_en')

        # Deleting field 'NationalAction.title_fr'
        db.delete_column(u'nbsap_nationalaction', 'title_fr')

        # Deleting field 'NationalAction.title_nl'
        db.delete_column(u'nbsap_nationalaction', 'title_nl')
    ...
    models = {
        ...
        u'nbsap.nationalaction': {
            ...
            'description_nl': ('tinymce.models.HTMLField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'title_fr': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'title_nl': ('django.db.models.fields.CharField', [], {'max_length': '512'})

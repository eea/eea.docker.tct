    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=16)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='tct.EuAction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_indicators', models.ManyToManyField(blank=True, related_name='other_targets', to='tct.EuIndicator')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='tct.EuTarget')),
            ],
            options={
                'ordering': ['code'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='tct.NationalObjective')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='eu_target',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eu_aichi_strategy', to='tct.EuTarget', verbose_name=b'EU Biodiversity Target'),
        ),
        migrations.AddField(
            model_name='euaichistrategy',

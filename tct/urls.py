...
urlpatterns = [
    ...
    url(r'^aichi/goals/(?P<code>[\w\-]+)/?$',
        views.list_targets, name='list_targets'),
    ...
    url(r'^aichi/targets/(?P<aichi_target_id>[\w\-]+)$',
        views.aichi_target_detail,
        name='aichi_target_detail'),
    ...
    url(r'^national-strategy/implementation/$',
    ...
    url(r'^national-strategy/objectives$',
